...
elseif($method=='cj'){
    ...
    foreach($array3[1] as $key=>$value){
        ...
        $d_name = format_vodname($array3[$xn_d_name][$key]); $d_name = str_replace("'", "''",$d_name);
        $d_remarks = $array3[$xn_d_remarks][$key]; $d_remarks = str_replace("'", "''",$d_remarks);
        ...
        $d_starring = htmlspecialchars_decode($array3[$xn_d_starring][$key]); $d_starring = str_replace("'", "''",$d_starring);
        $d_directed = htmlspecialchars_decode($array3[$xn_d_directed][$key]); $d_directed = str_replace("'", "''",$d_directed);
        $d_pic = $array3[$xn_d_pic][$key]; $d_pic = str_replace("'", "''",$d_pic);
        $d_time = $array3[$xn_d_time][$key];
        $d_year = intval($array3[$xn_d_year][$key]);
        $d_area = $array3[$xn_d_area][$key]; $d_area = str_replace("'", "''",$d_area);
        $d_lang = $array3[$xn_d_lang][$key]; $d_lang = str_replace("'", "''",$d_lang);
        $d_content = htmlspecialchars_decode($array3[$xn_d_content][$key]); $d_content = str_replace("'", "''",$d_content);
        $d_playurls = htmlspecialchars_decode($array3[$xn_d_urls][$key]); $d_playurls = str_replace("'", "",$d_playurls);
